...
class MappingWithKnownPoses(Node):
    def __init__(self, name):
        ...
        self.declare_parameter("header_frame_id", "odom")

        width = self.get_parameter("width").value
        height = self.get_parameter("height").value
        resolution = self.get_parameter("resolution").value
        header_frame_id = self.get_parameter("header_frame_id").value
        ...
        self.map_.header.frame_id = header_frame_id 
        # self.map_.header.frame_id = "bumpy_alpha/odom" 
